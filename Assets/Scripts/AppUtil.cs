...
public static class AppUtil
{
    ...
    /// ドラッグの方向を取得
    /// </summary>
    /// <param name='basePos'>タップした時のポジション</param>
    /// <param name='nowPos'>現在タップしているポジション</param>
    public static Vector3 GetDragDirection(Vector3 basePos, Vector3 nowPos) {
        var vec = nowPos - basePos;
        return vec.normalized; //正規化
    }
}
